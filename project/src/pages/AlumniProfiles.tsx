...
const AlumniProfiles: React.FC = () => {
  ...
  const industries = ['all', 'Technology', 'Healthcare', 'Legal', 'Finance', 'Media', 'Engineering', 'Non-profit', 'Aerospace'];
  const locations = ['all', 'San Francisco, CA', 'Boston, MA', 'Washington, DC', 'New York, NY', 'Los Angeles, CA', 'Austin, TX', 'Seattle, WA', 'Colorado Springs, CO', 'Hawthorne, CA'];
