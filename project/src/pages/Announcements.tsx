        ...
        <div className="mt-20">
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-3xl p-12 text-white text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              ニュースレターを購読して、最新の同窓生ニュースやイベント更新情報を受信箱で直接受け取りましょう。
            </p>
            <div className="max-w-md mx-auto flex gap-4">
              <input
                type="email"
                placeholder="メールアドレスを入力"
                className="flex-grow px-6 py-4 rounded-2xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-300"
              />
              <button className="bg-white text-blue-600 px-8 py-4 rounded-2xl font-semibold hover:bg-gray-50 transition-colors duration-200 whitespace-nowrap">
                購読
              </button>
            </div>
          </div>
