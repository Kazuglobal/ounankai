    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:hidden">
        <div className="px-4 py-6">
          ...
          {/* Regional Branch Activity Reports Section */}
          <section className="mb-8">
            <h2 className="text-lg font-bold text-gray-900 mb-4">各支部活動報告</h2>
            <div className="space-y-3">
              ...
              <div className="bg-white rounded-2xl shadow-md p-5">
                ...
                <div className="bg-gray-100 rounded-xl p-3 mb-3">
                  <p className="text-sm font-semibold text-gray-800 mb-2">次回開催予定</p>
                  <p className="text-xs text-gray-700 mb-1">令和7年3月2日午後6時から</p>
                  <p className="text-xs text-gray-700 mb-2">場所(予定) イタリア料理OTTO (盛岡市大通2丁目8-35)</p>
              ...
              <div className="bg-white rounded-2xl shadow-md p-5">
                ...
                <div className="relative h-32 bg-gradient-to-br from-yellow-100 to-orange-100 rounded-lg overflow-hidden">
              ...
              <div className="bg-white rounded-2xl shadow-md p-5">
                ...
                <div className="relative h-32 bg-gradient-to-br from-red-100 to-pink-100 rounded-lg overflow-hidden mb-3">
      ...
      <div className="hidden lg:block">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          {/* Regional Branch Activity Reports Section */}
          <section className="mb-16">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">各支部活動報告</h2>
            <div className="space-y-8">
              {/* 機友会 */}
              <div className="bg-white rounded-3xl shadow-lg p-8">
                <h4 className="text-xl font-bold text-morioka-700 mb-3">機友会 報告</h4>
                <h5 className="text-lg font-semibold text-gray-800 mb-3">令和六年度機友会総会報告</h5>
              ...
              {/* 二日会 */}
              <div className="bg-white rounded-3xl shadow-lg p-8">
                <h4 className="text-xl font-bold text-morioka-700 mb-3">二日会 報告</h4>
                <h5 className="text-lg font-semibold text-gray-800 mb-3">二日会第五十五回総会報告</h5>
                ...
                <div className="bg-gray-100 rounded-2xl p-6 mb-4">
                  <p className="text-base font-semibold text-gray-800 mb-3">次回開催予定</p>
                  <p className="text-sm text-gray-700 mb-2">令和7年3月2日午後6時から</p>
                  <p className="text-sm text-gray-700 mb-3">場所(予定) イタリア料理OTTO (盛岡市大通2丁目8-35)</p>
              ...
              {/* 桜化会 */}
              <div className="bg-white rounded-3xl shadow-lg p-8">
                <h4 className="text-xl font-bold text-morioka-700 mb-3">桜化会 報告</h4>
                <h5 className="text-lg font-semibold text-gray-800 mb-3">令和六年度桜化会活動報告書</h5>
              ...
              {/* 擬宝珠会 */}
              <div className="bg-white rounded-3xl shadow-lg p-8">
                <h4 className="text-xl font-bold text-morioka-700 mb-3">擬宝珠会 報告</h4>
                <h5 className="text-lg font-semibold text-gray-800 mb-3">令和六年度擬宝珠会総会報告</h5>
              ...
              <div className="bg-white rounded-3xl shadow-lg p-8 border-2 border-purple-200">
                <h4 className="text-xl font-bold text-morioka-700 mb-3">桐友会 報告</h4>
                <h5 className="text-lg font-semibold text-gray-800 mb-3">令和六年度桐友会活動報告</h5>
              ...
              {/* E友会 */}
              <div className="bg-white rounded-3xl shadow-lg p-8">
                <h4 className="text-xl font-bold text-morioka-700 mb-3">E友会 報告</h4>
                <h5 className="text-lg font-semibold text-gray-800 mb-3">E友会活動報告</h5>
              ...
              {/* 東京支部 */}
              <div className="bg-white rounded-3xl shadow-lg p-8">
                <h4 className="text-xl font-bold text-morioka-700 mb-3">東京支部 報告</h4>
                <h5 className="text-lg font-semibold text-gray-800 mb-3">東京支部総会2024報告</h5>
